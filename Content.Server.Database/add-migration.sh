...
dotnet ef migrations add --context CitadelSqliteContext -o Migrations/_Citadel/Sqlite "$1"
dotnet ef migrations add --context CitadelPostgresContext -o Migrations/_Citadel/Postgres "$1"
