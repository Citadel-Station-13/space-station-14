...
public sealed class GCQueuePrototype : IPrototype
{
    ...
    /// <summary>
    /// How deep the GC queue is at most. If this value is ever exceeded entities get processed automatically regardless of tick-time cap.
    /// </summary>
    [DataField("depth", required: true)]
    public int Depth { get; } = default!;
    ...
    public int MinDepthToProcess { get; } = default!;
    ...
    public bool TrySkipQueue { get; } = false;
}
