...
public class NoiseChannelConfig
{
    ...
    public float ClippedValue { get; } = 0.0f;
    /// <summary>
    ...
    /// <summary>
    /// Remaps the output of the noise function from the range (-1, 1) to (0, 1). This is done before all other output transformations.
    /// </summary>
    [DataField("remapTo0Through1")]
    public bool RemapTo0Through1 { get; } = false;
    /// <summary>
    /// For when the transformation you need is too complex to describe in YAML.
    /// </summary>
    [DataField("noisePostProcess")]
    public NoisePostProcess? NoisePostProcess { get; } = null;
    /// <summary>
